<?php
namespace Code\Main\Monitor\Models;
use Humble;
use Environment; 
/**
...
class User extends Model {
    ...
    /**
     * Will set the flag on ALL user accounts to force all users to reset their password... call at your own risk!
     * 
     * @return string
     */
    ...
    public function recoverPasswordEmail() {
        ...
        if ($data) {
            ...
            $user->save();
            $message = "\"<a href='&&PROJECT_URL&&/monitor/user/resetform?token={$token}&email={$email}'>Click here to reset your password</a>\"";
